    ...
    <div class="container pt-3 lg:px-40 md:px-6 px-5">
        ...
        <form action="{{ $product->exists ? route('products.update', $product) : route('products.store') }}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="name" name="name" class="border w-full mt-1" placeholder="Enter Name..." value="{{ old('name', $product->name) }}">
            </div>
            <div class="mb-3">
                <label for="photo" class="font-medium block">Photo:</label>
                <input type="file" name="photo" id="photo" class="border w-full mt-1">
                <img src="{{ $product->exists ? asset('storage/' .$product->photo) : '' }}" alt="" height="{{ $product->exists ? '100px' : ''}}">
            </div>
            <div class="mb-3">
                <label for="price" class="font-medium block">Price:</label>
                <input type="text" id="price" name="price" class="border w-full mt-1" placeholder="Enter Price..." value="{{ old('price', $product->price) }}">
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <select name="category_id" id="category_id" class="mt-1 w-full">
